...
import { AddWeightModal } from '@/components/WeightTracker/AddWeightModal';
import { WeightProgress } from '@/components/WeightTracker/WeightProgress';
...
import { ArrowRight, CheckCircle, Circle, Info, Timer, Weight } from 'lucide-react';
  ...
  return (
    <>
      <Card className={`transition-all duration-200 ${exercise.completed ? 'bg-green-50 border-green-200' : 'bg-white'}`}>
        ...
        <CardContent className="pt-0">
          <div className="space-y-4">
            ...
            {weightProgress && (
              <div className="mt-4">
                <WeightProgress exerciseName={exercise.name} />
              </div>
            )}
          </div>
        </CardContent>
      ...
      <AddWeightModal
        ...
        defaultWeight={weightProgress?.current_weight || 0}
        defaultReps={Number(exercise.reps) || 0}
